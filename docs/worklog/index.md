...
- [2026-08-04: 複数セッション対応の実機 E2E 検証](2026-08-04-multi-session-e2e.md) — 並行分離・完了時分離・ルールのみでの再開をすべて確認
- [2026-08-04: 状態保存・復元ライフサイクル文書の誤字脱字確認](2026-08-04-state-lifecycle-typos.md) — 明確な誤字・脱字・表記ゆれは 0 件
- [2026-08-04: PreCompact テストケースの網羅性分析](2026-08-04-pre-compact-test-coverage.md) — 実行経路は高網羅、仕様アサーションと堅牢性は中程度
- [2026-08-04: README の誤字脱字確認](2026-08-04-readme-typo-check.md) — 明確な誤字・脱字は 0 件
